...
const runDir = path.join(repoRoot, "validation-evidence/2026-05-23-phase-1-live-validation");
...
function writeReport(results) {
  ...
  writeFileSync(path.join(runDir, "PHASE_1_LIVE_VALIDATION_REPORT.md"), report);
